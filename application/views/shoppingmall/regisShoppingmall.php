    ...
    <div class="col-sm-12">
    	...
    	<p align="left"><b>เอกสารที่ต้องเตรียม</b></p>
      	...
      	<div class="border-1 indent-2 text-left">
      		...
      		<p>1. บัตรประชาชน (ในกรณีเป็นชาวต่างชาติ ใช้สำเนาหนังสือเดินทางหรือสำเนาใบอนุญาตทำงาน)</p>
			<p>2. สำเนาทะเบียนบ้าน หรือสัญญาเช่า</p>
			<p>3. ทะเบียนพาณิชย์ (สำหรับบริษัท: สำเนาหนังสือรับรองการจดทะเบียนบริษัท หรือห้างหุ้นส่วน จำกัด)</p>
			<p>4. สำเนาสมุดบัญชีธนาคารพร้อม Statement ย้อนหลัง 3 เดือน (หากต้องการใช้ระบบชำระเงินผ่านบัตรเครดิต)</p>
			<p>5. ใบอนุญาตประกอบธุรกิจนำเที่ยว โรงแรม หรือรีสอร์ท (ถ้ามี) (กรณีสมัคร eBooking)</p>
      	</div><br><br>
      	...
      	<p class="indent"><b>1. คุณสมบัติของผู้ขาย</b></p>
      	<div class="indent-3">	
      	...
      	<div class="indent-3">	
      		<p>&bull; คุณสามารถใช้งานระบบได้ฟรี 15 วัน (หรือตามโปรโมชั่นที่กำหนด) หลังจัดส่งเอกสารเรียบร้อย</p> 
      		<p>&bull; ร้านค้าของคุณจะแสดงผลได้ผ่านโดเมนเนมของคุณเอง เช่น www.yourshopname.com</p> 
      		
      	</div>
      	<p class="indent"><b>3. ข้อตกลงการโอนยอดรายได้</b></p>
      	<div class="indent-3">	
      		<p>ในกรณีที่ร้านค้าใช้ระบบไทยอีเพย์รับเงินจากบัตรเครดิตของผู้ซื้อ ทางไทยอีเพย์ระบบจะสรุปยอดรายได้ร้านค้าโดยรวบรวมในรอบ 1 เดือนและ โอนยอดรายได้จำนวนดังกล่าว หลังจากหักค่าธรรมเนียมให้แก่ร้านค้าในวันที่ 10 ของเดือนถัดไป โดยการนำฝากเข้าบัญชีธนาคารที่ร้านค้าแจ้งมา</p>   		
      	</div><br>
      	<center>
