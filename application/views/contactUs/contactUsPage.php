                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group" >
                                ...
                                <input type="text" class="form-control" name="ctl00$CphBody$TxtName" placeholder="<?php echo label('name', $this);
                                echo "-";
                                echo label('surname', $this); ?>" >
                            </div>
...
<?php echo label('email', $this); ?>
                            ...
                            <div class="form-group">
                                <select  class="form-control" name="ctl00$CphBody$DdlSubject"  onchange="javascript:setTimeout( & #39; __doPostBack(\ & #39; ctl00$CphBody$DdlSubject\ & #39; , \ & #39; \ & #39; ) & #39; , 0)" id="ctl00_CphBody_DdlSubject">
...
<?php echo label('description', $this); ?>
        ...
        <form id="form1" name="form1" method="post" action="">
            <div id="verify_math">
                ...
                <span>
                <span>=</span>
                <input name="i_verify" class="form-control" type="text" id="i_verify" />
                </span>
            </div> <br /><br />
