                    ...
                    <li> 
                        ...
                        <ul class="col-sm-10">
                           <li>
                                ...
                                <b><a href="<?php echo base_url()?>service/service/ePayment">ePayment</a></b><br> ระบบเพย์เมนท์เกตเวย์

                            </li><br>
                            <li>
                                 <img src="<?php echo base_url();?>assets/images/icons/ico_ecart_new.png">
                                <b><a href="<?php echo base_url()?>service/service/eCart">eCart</a> </b><br>ระบบตะกร้าสินค้า

                            </li><br>
                            <li>
                                <img src="<?php echo base_url();?>assets/images/icons/ico_ebooking_new.png">
                                <b><a href="<?php echo base_url()?>service/service/eBooking">eBooking</a></b> <br>(ระบบจองโรงแรม / ที่พัก) เหมาะสำหรับธุรกิจโรงแรม รีสอร์ท
    ...
    <div class="col-md-2">
      ...
      <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
          <li><a href="<?php echo base_url();?>merchantList/merchantList/merchantListPage">รายชื่อร้านค้า</a></li>
        
        </ul>
      </div>
      <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
          <li><a href="<?php echo base_url();?>aboutCompany/aboutCompany/aboutUsPage">เกี่ยวกับเรา</a></li>
        </ul>
      </div>
      <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
          <li><a href="<?php echo base_url();?>aboutCompany/aboutCompany/themePage">ธีมและแทมเพลต</a></li>           
        </ul>
      </div>  
            <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
          <li><a href="<?php echo base_url();?>aboutCompany/aboutCompany/conditionPage">ข้อตกลงและเงื่อนไข</a></li>           
        </ul>
      </div> 
    ...
    <div class="col-lg-4"></div>
        <div class="col-lg-4">
            <ul class="nav nav-pills nav-justified">
                <li><font color="white">© Copyright</font></li>
                <li><a href="<?php echo base_url();?>aboutCompany/aboutCompany/policyPage">ความเป็นส่วนตัว</a></li>
