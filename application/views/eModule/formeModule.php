...
<div class="container text-left">
    ...
    <div class="row col-sm-12">
        ...
        <div class="col-sm-8">
            ...
            <h4><?= label('AddressDetails',$this); ?></h4><br/>
            <div class="col-sm-4">
            ...
            <div class="col-sm-8">
                <div class="form-group">
                    ...
                    <label><?= label('contentWhichcate',$this); ?>?</label>
                </div>
            </div>
        ...
        <div class="col-sm-12">
            <p align="center"><?= label('contentTheseDe',$this);?></p><br>
        </div>
        <div class="col-sm-2"></div>
        <div class="col-sm-8">
            <div class="col-sm-4">
        ...
        <div class="col-sm-8 col-sm-offset-2">
            <h4><?= label('BankAccount',$this);?></h4>
            <p align="center">&bull;<?= label('contentBank',$this);?></p>
            <div class="col-sm-4">
                <div class="form-group">
